...
%To change bibliography styles, you need to get a \verb|.bst| file for the style. For example, you
%can see the IEEE bib style file, ACM bib style file and Springer bib style file in the same
